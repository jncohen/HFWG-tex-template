...
\def\hfwgsnapshotlicense{$snapshot_license_text$}
$else$
$if(snapshot_license)$
\def\hfwgsnapshotlicensekey{$snapshot_license$}
$else$
\def\hfwgsnapshotlicensekey{cc-by-nc-sa-4.0}
$endif$
\def\hfwgsnapshotlicense{CC BY-NC-SA 4.0}
\ifdefstring{\hfwgsnapshotlicensekey}{cc-by-4.0}{\def\hfwgsnapshotlicense{CC BY 4.0}}{}
\ifdefstring{\hfwgsnapshotlicensekey}{cc-by-sa-4.0}{\def\hfwgsnapshotlicense{CC BY-SA 4.0}}{}
\ifdefstring{\hfwgsnapshotlicensekey}{cc-by-nc-4.0}{\def\hfwgsnapshotlicense{CC BY-NC 4.0}}{}
\ifdefstring{\hfwgsnapshotlicensekey}{cc-by-nc-sa-4.0}{\def\hfwgsnapshotlicense{CC BY-NC-SA 4.0}}{}
\ifdefstring{\hfwgsnapshotlicensekey}{cc0-1.0}{\def\hfwgsnapshotlicense{CC0 1.0}}{}
\ifdefstring{\hfwgsnapshotlicensekey}{all-rights-reserved}{\def\hfwgsnapshotlicense{All rights reserved}}{}
\ifdefstring{\hfwgsnapshotlicensekey}{none}{\def\hfwgsnapshotlicense{}}{}
$endif$
$endif$
...
%% Fixed upper title placement: keep the title close to the top rule while
%% leaving the remaining metadata centered in the open field below.
\vspace*{0.325in}%
\begin{center}
\begin{singlespace}
...
\begin{minipage}[t]{\textwidth}
\vspace{0pt}
{\small\sffamily\bfseries\color{hfwgaccent}$if(series)$$series$$else$TeX Notes$endif$}\hfill
$if(date)$
\ifhfwganon\else
{\small $date$}%
\fi
...
\renewcommand{\section}[1]{%
  ...
  \ifnum\value{hfwgsnapshotsection}=$if(snapshot_switch_section)$$snapshot_switch_section$$else$3$endif$\relax
    \switchcolumn[1]%
  \fi
...
\vspace{0.35em}
{\scriptsize\singlespacing Download the code: {\color{hfwgaccent}$snapshot_code_url$}\par}
$else$
$if(snapshot_github_url)$
\vspace{0.35em}
{\scriptsize\singlespacing Download the code: {\color{hfwgaccent}$snapshot_github_url$}\par}
$endif$
$endif$
\end{paracol}
\vfill
...
\scriptsize\bfseries\color{hfwgaccent}TeX Notes
\end{minipage}\hfill
