...
$if(subtitle)$
\vspace{0.45em}
{\small\bfseries\color{hfwgaccent} $subtitle$\par}
$endif$
...
\setlength{\parindent}{0.85em}
\setlength{\parskip}{0pt}
\titleformat{\section}{\footnotesize\bfseries\color{hfwgaccent}}{}{0pt}{}
...
\vspace{-0.9em}
\includegraphics[width=\linewidth,height=0.95in,keepaspectratio]{$snapshot_feature$}
