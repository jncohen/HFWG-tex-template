...
\AddToShipoutPictureBG*{%
  \AtPageUpperLeft{%
    \put(\LenToUnit{1in},\LenToUnit{-1in}){%
      \raisebox{-3pt}[0pt][0pt]{%
        \textcolor{hfwgaccent}{\rule{\dimexpr\paperwidth-2in\relax}{3pt}}%
      }%
    }%
  }%
  \AtPageLowerLeft{%
...
\vspace*{\dimexpr 1.5in+3pt-\voffset-\topmargin-\headheight-\headsep\relax}
\begin{center}
\begin{singlespace}
