...
\hypersetup{
  pdftitle    = {Fontset Test: methods: Synthetic document for visual
regression checks},
...
\fancyhead[R]{\small\itshape Template: Fontset Test: methods}
...
Fontset Test Series\enspace\ensuremath{\cdot}\enspace No.\,5\par%
}%
}
...
\begin{center}
\begin{singlespace}
{\setstretch{0.9}\LARGE\bfseries Fontset Test: methods\par}
...
\begingroup
\setbox0=\hbox{\large\bfseries Fontset Test: methods}%
\ifdim\wd0>\linewidth
  \noindent\resizebox{\linewidth}{!}{\large\bfseries Fontset Test:
methods}\par
\else
  {\large\bfseries Fontset Test: methods\par}%
\fi
\endgroup
\end{minipage}\hfill
\par\vspace{0.35em}
...
\vspace{2.2em}
{\setstretch{0.92}\huge\scshape Fontset Test: methods\par}
\vspace{0.35em}
...
{\setstretch{0.86}\huge\bfseries Fontset Test: methods\par}
...
\pandocbounded{\includegraphics[keepaspectratio]{fontset-methods_files/fontset-methods_files/figure-latex/figure-example-1.pdf}}
