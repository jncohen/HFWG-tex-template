...
\hypersetup{
  pdftitle    = {Fontset Test: demography: Synthetic document for visual
regression checks},
...
\fancyhead[R]{\small\itshape Template: Fontset Test: demography}
...
Fontset Test Series\enspace\ensuremath{\cdot}\enspace No.\,4\par%
}%
}
...
\begin{center}
\begin{singlespace}
{\setstretch{0.9}\LARGE\bfseries Fontset Test: demography\par}
...
\begingroup
\setbox0=\hbox{\large\bfseries Fontset Test: demography}%
\ifdim\wd0>\linewidth
  \noindent\resizebox{\linewidth}{!}{\large\bfseries Fontset Test:
demography}\par
\else
  {\large\bfseries Fontset Test: demography\par}%
\fi
\endgroup
\end{minipage}\hfill
\par\vspace{0.35em}
...
\vspace{2.2em}
{\setstretch{0.92}\huge\scshape Fontset Test: demography\par}
\vspace{0.35em}
...
{\setstretch{0.86}\huge\bfseries Fontset Test: demography\par}
...
\small
\textbf{Ada Template}; \textbf{Sam Sample}\par
\vspace{0.35em}
Household Finance Working Group\par
\vspace{0.35em}
Fontset Test Series, No.\,4\par
\end{minipage}
...
\pandocbounded{\includegraphics[keepaspectratio]{fontset-demography_files/fontset-demography_files/figure-latex/figure-example-1.pdf}}
...
Household Finance Working Group\par
{\color{hfwgaccent}\url{https://example.edu/fontset-test}}\par
