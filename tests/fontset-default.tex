...
\hypersetup{
  pdftitle    = {Fontset Test: default: Synthetic document for visual
regression checks},
...
\fancyhead[R]{\small\itshape Template: Fontset Test: default}
...
Fontset Test Series\enspace\ensuremath{\cdot}\enspace No.\,1\par%
}%
}
...
\begin{center}
\begin{singlespace}
{\setstretch{0.9}\LARGE\bfseries Fontset Test: default\par}
...
\begingroup
\setbox0=\hbox{\large\bfseries Fontset Test: default}%
\ifdim\wd0>\linewidth
  \noindent\resizebox{\linewidth}{!}{\large\bfseries Fontset Test:
default}\par
\else
  {\large\bfseries Fontset Test: default\par}%
\fi
\endgroup
\end{minipage}\hfill
\par\vspace{0.35em}
...
\vspace{2.2em}
{\setstretch{0.92}\huge\scshape Fontset Test: default\par}
\vspace{0.35em}
...
{\setstretch{0.86}\huge\bfseries Fontset Test: default\par}
...
\pandocbounded{\includegraphics[keepaspectratio]{fontset-default_files/fontset-default_files/figure-latex/figure-example-1.pdf}}
