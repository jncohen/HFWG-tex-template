...
{\setstretch{0.88}\Large\bfseries The HFWG Template Turns R Markdown
Into Publishable Lab Documents\par}

\vspace{0.18em}
{\normalsize\bfseries\color{hfwgaccent} A Snapshot test for PDF and
WordPress output\par}
...
\vspace{-0.9em}
\includegraphics[width=0.43\linewidth,keepaspectratio]{intro-to-hfwgtex-snapshot-feature.png}
\vspace{-0.6em}
...
\noindent\fcolorbox{hfwgrule}{white}{%
  ...
  \textbf{Household Finance Lab}\par
  Public research note\par
  hhfinance.commons.gc.cuny.edu\par
  Short lab update on reproducible publishing workflows.
  \end{minipage}
  \end{minipage}%
}\par
\vspace{0.35em}
