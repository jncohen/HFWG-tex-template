...
\newlength{\hfwgsnapshotimageheight}
\setlength{\hfwgsnapshotfeatureheight}{$if(snapshot_feature_height)$$snapshot_feature_height$$else$2.95in$endif$}
\setlength{\hfwgsnapshotimageheight}{\dimexpr\hfwgsnapshotfeatureheight-0.50in\relax}
$endif$
\begin{paracol}{2}
...
$if(snapshot_feature)$
\noindent
\begin{minipage}[t][\hfwgsnapshotfeatureheight][t]{\linewidth}
\vspace{0pt}
\centering
\includegraphics[width=\linewidth,height=\hfwgsnapshotimageheight,keepaspectratio]{$snapshot_feature$}
...
\renewcommand{\section}[1]{%
  ...
  \ifnum\value{hfwgsnapshotsection}=4\relax
    \switchcolumn[1]%
  \fi
