...
%   fontset: hfwg        -> Source Serif 4 + Source Sans Pro, CUNY Blue accent (XeLaTeX/LuaLaTeX)
%                           mathpazo            (pdfLaTeX)
...
% hfwg:       sans-serif bold + CUNY Blue accent + rule below (branded)
% =======================================================
\usepackage{titlesec}
...
$if(snapshot)$
%% -------------------------------------------------------
%% SNAPSHOT: compact publication header.
%% The body begins on the first page after this header; use this for
%% short public-facing Lab outputs that also have a WordPress companion.
%% -------------------------------------------------------
\thispagestyle{empty}
...
{\setstretch{0.95}\LARGE\bfseries $title$\par}
...
\small\singlespacing
\noindent\textbf{$if(snapshot_abstract_label)$$snapshot_abstract_label$$else$Lead$endif$}\par\vspace{0.25em}
$abstract$
$if(keywords)$
\par\vspace{0.75em}
...
\vspace{1.25em}
\begin{center}
\includegraphics[width=0.92\linewidth,keepaspectratio]{$snapshot_feature$}
...
\vspace{1.5em}
\noindent\textcolor{hfwgrule}{\rule{\textwidth}{0.5pt}}\par
\vspace{1.5em}
...
%% Title, then subtitle, then tight author+affiliation+
%% institution+series+date block, then abstract.
%% -------------------------------------------------------
\begin{titlepage}
\thispagestyle{empty}
\noindent\textcolor{hfwgaccent}{\rule{\textwidth}{3pt}}\par
\vspace*{0.13\textheight}
\begin{center}
\begin{singlespace}
