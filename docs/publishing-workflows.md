...
Use Blogposts for public-facing Lab posts that should keep the standard HFWG report PDF style. They are not necessarily built around one featured visualization.
