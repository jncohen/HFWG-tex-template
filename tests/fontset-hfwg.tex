...
\hypersetup{
  pdftitle    = {Fontset Test: hfwg: Synthetic document for visual
regression checks},
  pdfauthor   = {Ada Template; Junior Co-Author A; Junior Co-Author B},
...
\fancyhead[R]{\small\itshape Template: Fontset Test: hfwg}
...
65-30 Kissena Blvd., Queens, NY 11367, USA\par%
\href{mailto:ada.template@example.edu}{\nolinkurl{ada.template@example.edu}}\par%
\url{https://example.edu/fontset-test}\par%
...
%% addresses, so wrapping again would cause nested \href recursion.
{\setlength{\parskip}{1pt}%
\textbf{Junior Co-Author A}\par
{\small%
%
Graduate Center, City University of New York\par%
%
%
%
ORCID: 0000-0002-5555-0001\par%
}}%
%
\vspace{0.75em}%
%
...
%% addresses, so wrapping again would cause nested \href recursion.
{\setlength{\parskip}{1pt}%
\textbf{Junior Co-Author B}\par
{\small%
%
Baruch College, City University of New York\par%
%
%
%
ORCID: 0000-0002-5555-0002\par%
}}%
%
\fi
}
...
Fontset Test Series\enspace\ensuremath{\cdot}\enspace No.\,2\par%
}%
}
...
\begin{center}
\begin{singlespace}
{\setstretch{0.9}\LARGE\bfseries Fontset Test: hfwg\par}

\vspace{0.35em}
{\large\color{hfwgaccent} Synthetic document for visual regression
checks\par}
\end{singlespace}
\end{center}
\vfill
...
\vspace{0pt}
{\small\sffamily\bfseries\color{hfwgaccent}Fontset Test Series}\hfill
\ifhfwganon\else
{\small May 2026}%
\fi
\par\vspace{0.35em}
...
\begingroup
\setbox0=\hbox{\large\bfseries Fontset Test: hfwg}%
\ifdim\wd0>\linewidth
  \noindent\resizebox{\linewidth}{!}{\large\bfseries Fontset Test:
hfwg}\par
\else
  {\large\bfseries Fontset Test: hfwg\par}%
\fi
\endgroup
\end{minipage}\hfill
\par\vspace{0.35em}
...
Ada Template, Junior Co-Author A, Junior Co-Author B%
}\par
{\scriptsize Household Finance Working Group}\par

\vspace{0.45em}
{\small\bfseries\color{hfwgaccent} Synthetic document for visual
regression checks\par}
...
\vspace{2.2em}
{\setstretch{0.92}\huge\scshape Fontset Test: hfwg\par}
\vspace{0.35em}
...
{\small\bfseries\MakeUppercase{Fontset Test Series}%
\enspace\textbar\enspace No.\,2%
\hfill
May 2026}\par
\vspace{0.45em}
...
{\setstretch{0.86}\huge\bfseries Fontset Test: hfwg\par}
...
\small
\textbf{Ada Template}; \textbf{Junior Co-Author A}; \textbf{Junior
Co-Author B}\par
\vspace{0.35em}
Household Finance Working Group\par
\vspace{0.35em}
Fontset Test Series, No.\,2\par
\end{minipage}
...
\small
\textbf{Abstract.} This fake manuscript tests title-page metadata, body
typography, citations, headings, mathematical notation, tables, figures,
and code formatting across the available HFWG template fontsets.
\par\vspace{0.45em}
...
\pandocbounded{\includegraphics[keepaspectratio]{fontset-hfwg_files/fontset-hfwg_files/figure-latex/figure-example-1.pdf}}
...
\bibitem[\citeproctext]{ref-hfwg2026}
...
\textbf{Ada Template, Junior Co-Author A, Junior Co-Author B}\par
Template author\par
Household Finance Working Group\par

Maintains public-facing template examples and publication workflows.
\end{minipage}
\end{minipage}\par
\end{multicols}
\vfill
